    ...
    render() {
        return html`
            <div class="form"> 
                ...
                <input name="login" required autocomplete="username" placeholder="Login">
                <input name="password" required autocomplete="new-password" placeholder="Password" type="password">
                <button class="submit" @click="${this.submit}">Submit</button>
            </div>
            <div>Or <a class="link" href="/auth/register">register</a></div>
        `;
    }
